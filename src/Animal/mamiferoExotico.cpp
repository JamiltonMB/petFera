...
MamiferoExotico::MamiferoExotico(size_t id, string nome, string sexo, int idade, float peso, 
                           ...
                           Mamifero(id, nome, sexo, idade, peso, comprimento, patas, 
                           especie, tipo_pele,alimento, silvestreOuExotico, vetResponsavel,
