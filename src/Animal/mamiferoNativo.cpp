...
MamiferoNativo::MamiferoNativo(int id, string nome, string sexo, int idade, float peso, float comprimento,
                               ...
                               string tratadorResponsavel, string cor_pelo, string dentes, string licenca_IBAMA, string UF_origem) : Mamifero(id, nome, sexo, idade, peso, comprimento, ambiente, patas, especie, tipo_pele, tipo_reproducao,
