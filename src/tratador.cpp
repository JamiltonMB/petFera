...
Tratador::Tratador(std::string matricula, std::string nome, std::string idade, std::string celular, std::string endereco, std::string cpf, std::string cargo, std::string nivel_seguranca):
						Funcionario(matricula,nome,idade,celular,endereco,cpf,cargo), nivel_seguranca(nivel_seguranca){}
Tratador::Tratador(int id, std::string matricula, std::string nome, std::string idade, std::string celular, std::string endereco, std::string cpf, std::string cargo, std::string nivel_seguranca):
						Funcionario(id,matricula,nome,idade,celular,endereco,cpf,cargo), nivel_seguranca(nivel_seguranca){}
